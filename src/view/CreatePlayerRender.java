...
public class CreatePlayerRender extends JFrame {
	...
	public void run() {
		try {
			CreatePlayerRender frame = new CreatePlayerRender();
	...
	public CreatePlayerRender() {
		...
		JLabel lblNewLabel = new JLabel("Nouveau joueur");
		lblNewLabel.setBounds(153, 22, 106, 23);
		panel.add(lblNewLabel);
		
		JTextField textName = new JTextField();
		textName.setBounds(114, 81, 86, 20);
		panel.add(textName);
		textName.setColumns(10);
		
		JLabel labelName = new JLabel("Nom");
		labelName.setBounds(22, 80, 41, 23);
		panel.add(labelName);
		
		JButton btnCreate = new JButton("Cr\u00E9er");
		btnCreate.setBounds(71, 131, 120, 44);
		panel.add(btnCreate);
		
		JRadioButton rdbtnImportDefaultCards = new JRadioButton("Importer cartes par defaut");
		rdbtnImportDefaultCards.setBounds(218, 142, 168, 23);
		panel.add(rdbtnImportDefaultCards);
		...
		btnCreate.addActionListener(new ActionListener() {
	  		  ...
	  		  public void actionPerformed(ActionEvent arg0) {
	  			...
	  			if(rdbtnImportDefaultCards.isSelected()) {
	  				cards = loadCards();
	  			}
	  			Player player = new Player(cards, textName.getText());
	  			CardsCollectionRender cdp = new CardsCollectionRender(player);
	  			cdp.run();
	  			 
	  		  }
	  	  });
		btnCreate.addActionListener(e -> this.dispose());
	}
	
	public static ArrayListCard loadCards() {
		  
		  ArrayListCard cards = new ArrayListCard();
		  Card mat = new Card("Le Mat", 
		  ...
		  Card bateleur = new Card("Le Bateleur",
		  ...
		  Card papesse = new Card("La Papesse",
		  ...
		  Card imperatrice = new Card("L'impératrice",
		  ...
		  Card empereur = new Card ("L'empereur",
		  ...
		  Card amoureux = new Card ("L'Amoureux",
		  ...
		  Card chariot = new Card ("Le Chariot",
		  ...
		  Card justice = new Card ("La Justice", 
		  ...
		  Card hermite = new Card ("L'Hermite", 
		  ...
		  Card roue = new Card ("La Roue de Fortune",
		  ...
		  Card arcanne = new Card ("L'Arcane Sans Nom (La Mort)",
		  ...
		  Card temperance = new Card ("La Tempérance", 
		  ...
		  Card diable = new Card ("Le Diable", 
		  ...
		  Card maison = new Card ("La Maison-Dieu",
		  ...
		  Card soleil = new Card ("Le Soleil", 
		  ...
		  Card jugement = new Card ("Le Jugement", 
